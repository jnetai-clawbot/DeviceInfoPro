...
public class AboutActivity extends AppCompatActivity {
    ...
    private static final String GITHUB_RELEASES_URL = "https://api.github.com/repos/jnetai-clawbot/DeviceInfoPro/releases/latest";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            tvAbout.setText("Device Info Pro\n\nDetailed Android hardware, software, and network information.\n\nMade by jnetai.com");
    ...
    private void shareApp() {
        try {
            ...
            shareIntent.putExtra(Intent.EXTRA_SUBJECT, "Device Info Pro");
            shareIntent.putExtra(Intent.EXTRA_TEXT,
                "Check out Device Info Pro - Detailed Android hardware & software info!\n\n" +
                "https://github.com/jnetai-clawbot/DeviceInfoPro/releases\n\nMade by jnetai.com");
